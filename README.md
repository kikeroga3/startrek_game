...
[教育用言語としての適性について]
「命令がいっぱいあってわかんなーい！」じゃなくて「これしかない」から始められるのがメリットと考えます。
ビギナーは命令や機能がたくさんあると気持ちが飽和してかえって迷うものです。
効果的な勉強には本人の意識が大切なのです。
慣れてくれば、少ない命令を工夫して目的を果たすという意識も自然ともてるので、
「ないと作れない」じゃなくて「なければ作る！」という逞しい教育効果も見込めるでしょう。
TinyHSPで「できた！」という成功体験をへて、TinyHSPに限界を感じてから次のプログラム言語へステップアップする。
プログラミングのファーストステップとして利用してもらえると良いかと思います。
